...
public class Main {
    public static void main(String[] args) {
        ...
        commandsToExecute.add(new Command(ParkCarCommand.COMMAND_NAME, List.of("KA01", "White")));
        commandsToExecute.add(new Command(ParkCarCommand.COMMAND_NAME, List.of("KA02", "White")));
        commandsToExecute.add(new Command(ParkCarCommand.COMMAND_NAME, List.of("KA04", "Black")));
        ...
        commandsToExecute.add( new Command(StatusCommand.COMMAND_NAME, List.of()));
        commandsToExecute.add( new Command(ParkCarCommand.COMMAND_NAME, List.of("KA03", "Red")));
        commandsToExecute.add( new Command(StatusCommand.COMMAND_NAME, List.of()));
        commandsToExecute.add( new Command(ParkCarCommand.COMMAND_NAME, List.of("KA05", "Red")));
        commandsToExecute.add( new Command(ParkCarCommand.COMMAND_NAME, List.of("KA06", "Red")));
        commandsToExecute.add( new Command(ParkCarCommand.COMMAND_NAME, List.of("KA07", "Brown")));
        commandsToExecute.add( new Command(StatusCommand.COMMAND_NAME, List.of()));
        commandsToExecute.add( new Command(ParkCarCommand.COMMAND_NAME, List.of("KA08", "Brown")));
